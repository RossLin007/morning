...
export const AICoach: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-screen h-full min-h-full bg-[#F5F7F5] dark:bg-black font-sans relative overflow-hidden animate-fade-in">
            ...
            <NavBar
                title={
                    <div className="flex flex-col items-center">
                        <span className="text-base font-bold text-text-main dark:text-white flex items-center gap-2">
            ...
            <div className="p-4 bg-white dark:bg-black border-t border-gray-100 dark:border-gray-800 pb-safe">
                ...
                <div className={`relative flex items-end gap-2 bg-gray-100 dark:bg-[#151515] rounded-3xl p-2 transition-all focus-within:ring-2 focus-within:ring-primary/20 ${!isOnline ? 'opacity-50 pointer-events-none' : ''}`}>
                    ...
                    <button
                        ...
                        className={`p-2 rounded-full transition-all ${input.trim() && !isAiThinking && isOnline
