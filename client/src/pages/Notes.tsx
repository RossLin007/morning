...
export const Notes: React.FC = () => {
  ...
  return (
    <div className="pb-24 animate-fade-in bg-background-light dark:bg-background-dark min-h-screen font-sans">
      ...
      <header className="sticky top-0 z-50 bg-white/90 dark:bg-surface-dark/90 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 px-4 py-3">
        <div className="flex items-center justify-between">
            <button onClick={() => navigate(-1)} className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
            <Icon name="arrow_back_ios_new" className="text-gray-600 dark:text-gray-300" />
            </button>
            
            {!showSearch ? (
                <h1 className="text-lg font-bold font-display tracking-tight text-center text-text-main dark:text-white animate-fade-in">
                    我的笔记 ({notes.length})
                </h1>
            ) : (
