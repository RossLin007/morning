...
export const NoteEditor: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full min-h-full bg-white dark:bg-background-dark animate-fade-in font-sans relative">
            <input type="file" ref={fileInputRef} className="hidden" accept="image/*" onChange={handleFileChange} />

            <NavBar
                left={<button onClick={() => navigate(-1)} className="text-gray-500 dark:text-gray-400 font-medium text-sm hover:text-gray-800 dark:hover:text-white transition-colors">取消</button>}
                title={
