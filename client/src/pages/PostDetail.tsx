...
import { usePost, useCommunity } from '@/hooks/useCommunity'; // Import hooks
...
export const PostDetail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black font-sans animate-fade-in flex flex-col pb-20 relative">
      <header className="sticky top-0 z-40 bg-white/80 dark:bg-black/80 backdrop-blur-xl border-b border-gray-100/50 dark:border-gray-800 px-4 py-3 flex items-center gap-4">
